...
# import json # Alexa NotifyMe
# import requests # Alexa NotifyMe
try:
...
def connect_balanceboard():
	...
	#
	print("{:.2f}".format(kg*2.20462/100.0))
	#print("{:.2f} +/- {:.2f}".format(kg*2.20462/100.0, err/100.0))
# Start Email Weight
	from email.MIMEMultipart import MIMEMultipart
	from email.MIMEText import MIMEText
	fromaddr = "daemon@ultrarucking.com"
	# toaddr = "scott@3one5.com"
	toaddr = "triggers@applet.ifttt.com"
	msg = MIMEMultipart()
 	msg['From'] = fromaddr
 	msg['To'] = toaddr
	msg['Subject'] = "#WiiScale"
 	body = ("{:.2f}".format(kg*2.20462/100.0))
...
# Start Alexa Notification
	# mass = "You weigh" + ("{:.2f}".format(kg*2.20462/100.0)) + "pounds"
	# body = json.dumps({
 	# "notification": mass,
	# "accessCode": "amzn1.ask.account.AGNOTJNYTYO5667YT6OPTQMSZXKCDAEGNAY4KCFXHERKZ4ITSWKMXWESMYMPA77M3M5F3AZABVWZX363KOOOINL6EH5U5YPSIXESTRPQWXK6S6Y3GSEUH64WFNKGXEJA752IFZEKJBMUCZTL5XO6BQAUDICEN4ABKAZOLQ4B2A2LDGY34OOC3HRA7WQUHQYRCAZX4X25YK45EFI"
	# })
	# requests.post(url = "https://api.notifymyecho.com/v1/NotifyMe", data = body)
# End Alexa Notification
